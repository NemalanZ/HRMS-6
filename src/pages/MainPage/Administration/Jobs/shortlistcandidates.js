...
const ShortlistCandidate = () => {
  ...
  const [data, setData] = useState([
    { id: 1, image: IMAGEROUTER.Avatar, name: "John Doe", role: "Web Designer", jobtitle: "Web Designer" },
    { id: 2, image: IMAGEROUTER.Avatar, name: "Richard Miles", role: "Web Developer", jobtitle: "Web Developer" },
    { id: 3, image: IMAGEROUTER.Avatar, name: "John Smith", role: "Android Developer", jobtitle: "Android Developer" },
  ]);
